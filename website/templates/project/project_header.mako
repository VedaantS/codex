...
<div id="projectBanner" >
    ...
    <div class="subhead">
        <nav id="projectSubnav" class="navbar osf-project-navbar" style="box-shadow: none; font-family: 'Outfit', sans-serif; background-color: #fefefe; outline: 0.5px solid black;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse project-nav">
                    ...
                    % endif
                        <li>
                            <a href="${node['url']}"  class="project-title subnav-header" style="color: white;">
                                ${ node['title'] }
                            </a>
                        </li>
