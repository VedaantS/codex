...
from codex.models import Collection
...
from codex.utils.workflows import CollectionSubmissionStates
from website.mails import mails
from codex.models.collection_submission import mails as collection_submission_mail
...
class TestImplicitRemoval:
    ...
    @mock.patch('codex.models.node.Node.check_privacy_change_viability', mock.Mock())  # mocks the storage usage limits
