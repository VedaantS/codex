...
from codex.models import Identifier
from codex.utils.identifiers import PID_VALIDATION_ENDPOINTS
from codex_tests.factories import RegistrationFactory
...
@mock.patch('codex.utils.identifiers.PID_VALIDATION_ENABLED', True)
