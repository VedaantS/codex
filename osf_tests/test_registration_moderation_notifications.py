...
from codex.management.commands.add_notification_subscription import add_reviews_notification_setting
from codex.management.commands.populate_registration_provider_notification_subscriptions import populate_registration_provider_notification_subscriptions

from codex.migrations import update_provider_auth_groups
from codex.models import Brand, NotificationDigest
from codex.models.action import RegistrationAction
from codex.utils import machines
from codex.utils.notifications import (
    notify_submit,
...
from codex.utils.workflows import RegistrationModerationTriggers, RegistrationModerationStates
...
class TestRegistrationMachineNotification:
    ...
    def setup(self):
        ...
        with mock.patch('codex.utils.machines.timezone.now', return_value=self.MOCK_NOW):
            yield
    ...
    def test_submit_notifications(self, registration, moderator, admin, contrib, provider):
        ...
        assert admin_message == call(
            ...
            is_creator=True,
            logo='codex_registries',
            no_future_emails=[],
            provider_contact_email=settings.CODEX_CONTACT_EMAIL,
            provider_support_email=settings.CODEX_SUPPORT_EMAIL,
    ...
    def test_branded_provider_notification_renders(self, registration, admin, moderator):
        ...
        # codex.utils.notifications and stores emails to be picked up in the moderator digest
        #
