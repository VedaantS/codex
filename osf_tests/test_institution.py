...
from codex.models import Institution, InstitutionStorageRegion
...
def test_institution_support_email():
    institution = InstitutionFactory(support_email='support@codex.edu')
    assert institution.support_email == 'support@codex.edu'
...
class TestInstitutionManager:
    ...
    def test_send_deactivation_email_call_args(self, mock_send_mail):
        ...
        mock_send_mail.assert_called_with(
            ...
            codex_support_email=settings.CODEX_SUPPORT_EMAIL
        )
