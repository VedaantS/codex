...
class TestRegistrationApprovalHooks:
    ...
    # Regression test for https://openscience.atlassian.net/browse/CODEX-4940
    @mock.patch('codex.models.node.AbstractNode.update_search')
...
class TestDOICreation:
    ...
    def test_moderated_sanction__no_identifier_created_until_moderator_approval(self, embargoed):
        ...
        with mock.patch('codex.models.node.AbstractNode.update_search'):
