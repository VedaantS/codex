...
from codex.models import Sanction

from tests.base import CodexTestCase
from codex_tests.factories import ProjectFactory, NodeFactory, RetractionFactory, CollectionFactory, RegistrationFactory
...
class TestValidProject(CodexTestCase):
