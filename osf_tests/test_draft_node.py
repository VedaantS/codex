...
from codex.utils.permissions import READ, WRITE, ADMIN
...
class TestDraftNode:
    ...
    def test_draft_node_creation(self, user):
        ...
        assert draft_node.has_addon('codexstorage') is True
    ...
    def test_create_draft_registration_without_node(self, user):
        ...
        assert draft.branched_from.type == 'codex.draftnode'
    ...
    def test_register_draft_node(self, user, draft_node, draft_registration):
        assert draft_node.type == 'codex.draftnode'
        ...
        draft_node.reload()
        assert draft_node.type == 'codex.node'
    ...
    def test_draft_registration_fields_are_not_copied_back_to_original_node(self, user, institution, project,
        ...
        project.reload()
        assert project.type == 'codex.node'
