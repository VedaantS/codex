...
from codex.metrics.reporters.private_spam_metrics import PrivateSpamMetricsReporter
from codex.metrics.utils import YearMonth
from codex_tests.factories import NodeLogFactory, NodeFactory
...
def test_private_spam_metrics_reporter():
    ...
    with patch('codex.external.oopspam.client.OOPSpamClient.get_flagged_count') as mock_oopspam_get_flagged_count, \
         patch('codex.external.oopspam.client.OOPSpamClient.get_hammed_count') as mock_oopspam_get_hammed_count, \
         patch('codex.external.askismet.client.AkismetClient.get_flagged_count') as mock_akismet_get_flagged_count, \
         patch('codex.external.askismet.client.AkismetClient.get_hammed_count') as mock_akismet_get_hammed_count:
