...
from website.util.metrics import CodexSourceTags
...
from codex.features import ENABLE_GV
...
class TestUserMerging(CodexTestCase):
    def setUp(self):
        super().setUp()
    ...
    def test_merge_unconfirmed(self):
        ...
        assert sorted(self.user.system_tags) == sorted(['shared', 'user', 'unconfirmed', CodexSourceTags.Codex.value])
